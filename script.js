...
const TRANSLATIONS = {
    en: {
        ...
        term_s2_desc:  "Solar Cloud provides hosting services including: Minecraft server hosting, Discord bots, and web applications.",
        ...
        term_s3_box:   "<strong>⚠️ Backup Notice:</strong> We recommend periodically downloading backups of your worlds to your local storage.",
        term_s4_title: "4. Acceptable Use Policy",
        term_s4_desc:  "You agree NOT to use our services to: Host or distribute illegal content, launch DDoS attacks, or engage in network abuse.",
        term_s4_box:   "<strong>🚫 Strict Prohibition:</strong> Cryptocurrency mining and network abuse will result in immediate and permanent account termination and suspension without compensation.",
        ...
        term_s6_desc:  "You must be at least 18 years old, or have explicit and verifiable consent from your parents or legal guardians, to use and purchase our services.",
        term_s7_title: "7. Limitation of Legal Liability",
        term_s7_desc:  "In no event shall Solar Cloud's total liability to you for any damage or loss exceed the total amount paid by you to our company during the month prior to the event giving rise to the claim.",
        term_s8_title: "8. Jurisdiction & Governing Law",
        term_s8_desc:  "These Terms are governed by and construed in accordance with the laws of the Republic of Colombia. Any dispute shall be submitted to the exclusive jurisdiction of Colombian laws and courts.",
        ...
        ref_s1_box:    "<strong>⚠️ Final Sales:</strong> We recommend carefully reviewing your order before completing payment.",
    ...
    es: {
        ...
        term_s2_desc:  "Solar Cloud proporciona servicios de alojamiento que incluyen: Alojamiento de servidores de Minecraft, bots de Discord y aplicaciones web.",
        ...
        term_s3_box:   "<strong>⚠️ Nota sobre Backups:</strong> Te recomendamos descargar periódicamente copias de seguridad de tus mundos a tu almacenamiento local.",
        term_s4_title: "4. Política de Uso Aceptable",
        term_s4_desc:  "Aceptas NO utilizar nuestros servicios para: Alojar o distribuir contenido ilegal, lanzar ataques DDoS o abuso de red.",
        term_s4_box:   "<strong>🚫 Prohibición Estricta:</strong> La minería de criptomonedas y el abuso de red resultarán en la terminación y suspensión inmediata y permanente de la cuenta sin derecho a compensación.",
        ...
        term_s6_desc:  "Debes tener al menos 18 años, o contar con el consentimiento explícito y verificable de tus padres o tutores legales, para utilizar y comprar nuestros servicios.",
        term_s7_title: "7. Límite de Responsabilidad Legal",
        term_s7_desc:  "En ningún caso la responsabilidad total de Solar Cloud hacia ti por cualquier daño o pérdida excederá el monto total pagado por ti a nuestra empresa durante el mes anterior al evento que originó el reclamo.",
        term_s8_title: "8. Jurisdicción y Ley Aplicable",
        term_s8_desc:  "Estos Términos se rigen e interpretan de acuerdo con las leyes de la República de Colombia. Cualquier disputa será sometida a la jurisdicción exclusiva de las leyes y tribunales colombianos.",
        ...
        ref_s1_box:    "<strong>⚠️ Ventas Finales:</strong> Te recomendamos revisar cuidadosamente tu pedido antes de completar el pago.",
