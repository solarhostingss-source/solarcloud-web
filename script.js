...
const TRANSLATIONS = {
    en: {
        ...
        otherPlansDesc: "From lightweight friend servers to high-capacity networks for large communities.",
        ...
        term_s1_desc:  "By accessing or using any service provided by Solar Cloud ('we', 'our', or 'the Company'), you agree to be bound by these Terms of Service. If you do not agree, you must not use our services.",
        term_s2_title: "2. Description of Services",
        term_s2_desc:  "Solar Cloud provides hosting services including:",
        term_s2_li1:   "Minecraft server hosting.",
        term_s2_li2:   "Discord bot hosting.",
        term_s2_li3:   "Web application hosting.",
        term_s3_title: "3. Account Responsibilities & Backups",
        term_s3_desc:  "You are responsible for maintaining the confidentiality of your credentials. Solar Cloud does not keep or guarantee backups of your server data. It is the sole responsibility of the user to create and store their backups.",
        term_s3_box:   "<strong>⚠️ Backup Notice:</strong> We strongly recommend periodically downloading backups of your worlds and databases to your local storage.",
        term_s4_title: "4. Acceptable Use Policy",
        term_s4_desc:  "You agree NOT to use our services to:",
        term_s4_li1:   "Host or distribute illegal content.",
        term_s4_li2:   "Launch DDoS attacks or network abuse.",
        term_s4_li3:   "Mine cryptocurrencies (Strictly prohibited, will result in permanent suspension).",
        term_s4_box:   "<strong>🚫 Strict Prohibition:</strong> Cryptocurrency mining and deliberate network abuse will result in immediate and permanent account termination without compensation.",
        term_s5_title: "5. Performance & Optimization (Anti-Lag Clause)",
        term_s5_desc:  "We guarantee the delivery of all contracted hardware resources. However, we are not responsible for lag, drops, or crashes caused by user misconfiguration (plugin overload, /rtp command abuse, etc.).",

        // Refund Policy (EN)
        ref_s1_title:  "1. Strict No Refunds Policy",
        ref_s1_desc:   "Solar Cloud operates under a strict NO REFUNDS policy. All sales are final. We do not offer refunds or credits under any circumstances.",
        ref_s1_box:    "<strong>⚠️ Final Sales:</strong> We recommend carefully reviewing your order and plan specifications before completing payment.",
        ref_s2_title:  "2. Consumed Service Clause",
        ref_s2_desc:   "A service is considered 'delivered and consumed' the moment the server is provisioned and powered on. No refunds will be granted for 'buyer's remorse' or 'item not as described' once resources are utilized.",
        ref_s3_title:  "3. Disputes & Chargebacks",
        ref_s3_desc:   "Any attempt to dispute a payment or initiate a chargeback with PayPal or your bank without using our official support will be considered fraud. This will result in immediate termination of services, total loss of data, and a permanent blacklist from our platform.",
        ref_s3_box:    "<strong>💬 Official Support:</strong> If you experience any billing issues, please contact our support team first via Discord or email at <strong>solarhostingss@gmail.com</strong> to resolve it directly.",

        // Privacy Policy (EN)
        priv_s1_title: "1. Introduction",
        priv_s1_desc:  "<strong>Solar Cloud</strong> is committed to protecting your privacy. This Privacy Policy explains what information we collect, how we use it, and your rights regarding your personal data when using our services.",
        priv_s2_title: "2. Information We Collect",
        priv_s2_desc:  "We collect the following types of information:",
        priv_s2_li1:   "<strong>Account Information:</strong> Name, email address, and encrypted password upon registration.",
        priv_s2_li2:   "<strong>Billing Information:</strong> Payment details processed securely through our platform (Paymenter). We do not store complete card numbers.",
        priv_s2_li3:   "<strong>Usage Data:</strong> Server resource usage (RAM, CPU, bandwidth) for billing and performance monitoring purposes.",
        priv_s2_li4:   "<strong>Log Data:</strong> IP addresses, browser types, and timestamps for security and support purposes.",
        ...
        priv_s3_li3:   "Send service-related communications (maintenance, updates, support).",
        priv_s3_li4:   "Detect and prevent fraud, abuse, or security incidents.",
        priv_s3_li5:   "Comply with applicable legal obligations.",
        priv_s3_box:   "We <strong>do not sell</strong>, rent, or share your personal data with third parties for marketing purposes.",
        priv_s4_title: "4. Data Retention",
        priv_s4_desc:  "We retain your personal data while your account is active or as needed to provide services. You may request deletion of your data at any time by contacting us.",
        priv_s5_title: "5. Data Security",
        priv_s5_desc:  "We implement industry-standard security measures to protect your data, including SSL/TLS encryption for data in transit and encrypted password storage.",
        priv_s6_title: "6. Third-Party Services",
        priv_s6_desc:  "We use the following services which may process your data under their own privacy policies:",
    ...
    es: {
        ...
        term_s1_desc:  "Al acceder o utilizar cualquier servicio proporcionado por Solar Cloud ('nosotros', 'nuestro' o 'la Empresa'), aceptas estar sujeto a estos Términos de Servicio. Si no estás de acuerdo, no debes utilizar nuestros servicios.",
        term_s2_title: "2. Descripción de los Servicios",
        term_s2_desc:  "Solar Cloud proporciona servicios de alojamiento que incluyen:",
        term_s2_li1:   "Alojamiento de servidores de Minecraft.",
        term_s2_li2:   "Alojamiento de bots de Discord.",
        term_s2_li3:   "Alojamiento de aplicaciones web.",
        term_s3_title: "3. Responsabilidad de la Cuenta y Copias de Seguridad (Backups)",
        term_s3_desc:  "Eres responsable de mantener la confidencialidad de tus credenciales. Solar Cloud no guarda ni garantiza copias de seguridad de los datos de tu servidor. Es responsabilidad exclusiva del usuario crear y almacenar sus backups.",
        term_s3_box:   "<strong>⚠️ Nota sobre Backups:</strong> Te recomendamos descargar periódicamente copias de seguridad de tus mundos y bases de datos a tu almacenamiento local.",
        term_s4_title: "4. Política de Uso Aceptable",
        term_s4_desc:  "Aceptas NO utilizar nuestros servicios para:",
        term_s4_li1:   "Alojar o distribuir contenido ilegal.",
        term_s4_li2:   "Lanzar ataques DDoS o abuso de red.",
        term_s4_li3:   "Minar criptomonedas (Prohibido estrictamente, causará suspensión permanente).",
        term_s4_box:   "<strong>🚫 Prohibición Estricta:</strong> La minería de criptomonedas y el abuso deliberado de red resultarán en la terminación y suspensión inmediata y permanente de la cuenta sin derecho a compensación.",
        term_s5_title: "5. Rendimiento y Optimización (Cláusula Anti-Lag)",
        term_s5_desc:  "Garantizamos la entrega de los recursos de hardware contratados. Sin embargo, no nos hacemos responsables por lag, caídas o crasheos causados por una mala configuración del usuario (exceso de plugins, abuso del comando /rtp, etc.).",

        // Refund Policy (ES)
        ref_s1_title:  "1. Política Estricta de Cero Reembolsos (No Refunds)",
        ref_s1_desc:   "Solar Cloud opera bajo una estricta política de NO REEMBOLSOS. Todas las ventas son finales. No ofrecemos reembolsos ni créditos bajo ninguna circunstancia.",
        ref_s1_box:    "<strong>⚠️ Ventas Finales:</strong> Te recomendamos revisar cuidadosamente tu pedido y las especificaciones del plan antes de completar el pago.",
        ref_s2_title:  "2. Cláusula de Servicio Consumido",
        ref_s2_desc:   "Se considera que el servicio ha sido 'entregado y consumido' en el momento en que el servidor es aprovisionado y encendido. No se otorgarán reembolsos por 'arrepentimiento de compra' o 'artículo distinto a lo descrito' una vez utilizados los recursos.",
        ref_s3_title:  "3. Disputas y Contracargos",
        ref_s3_desc:   "Cualquier intento de disputar un pago o iniciar un contracargo (chargeback) en PayPal o tu banco sin usar nuestro soporte oficial será considerado fraude. Esto resultará en la terminación inmediata de tus servicios, pérdida total de datos y bloqueo (blacklist) de nuestra plataforma.",
        ref_s3_box:    "<strong>💬 Contacto Oficial:</strong> Si presentas cualquier inconveniente con tu facturación, comunícate primero con nuestro equipo de soporte a través de Discord o por correo electrónico a <strong>solarhostingss@gmail.com</strong> para resolverlo directamente.",

        // Privacy Policy (ES)
        priv_s1_title: "1. Introducción",
        priv_s1_desc:  "<strong>Solar Cloud</strong> se compromete a proteger tu privacidad. Esta Política de Privacidad explica qué información recopilamos, cómo la usamos y tus derechos con respecto a tus datos personales cuando utilizas nuestros servicios.",
        priv_s2_title: "2. Información que Recopilamos",
        priv_s2_desc:  "Recopilamos los siguientes tipos de información:",
        priv_s2_li1:   "<strong>Información de la Cuenta:</strong> Nombre, correo electrónico y contraseña (encriptada) al registrarte.",
        priv_s2_li2:   "<strong>Información de Facturación:</strong> Detalles de pago procesados de forma segura a través de nuestra plataforma (Paymenter). No almacenamos números de tarjeta completos.",
        priv_s2_li3:   "<strong>Datos de Uso:</strong> Uso de recursos del servidor (RAM, CPU, ancho de banda) para fines de facturación y monitoreo de rendimiento.",
        priv_s2_li4:   "<strong>Datos de Registro:</strong> Direcciones IP, tipo de navegador y marcas de tiempo para fines de seguridad y soporte.",
        priv_s3_title: "3. Cómo Usamos tu Información",
        priv_s3_desc:  "Utilizamos tu información para:",
        priv_s3_li1:   "Proporcionar, mantener y mejorar nuestros servicios de hosting.",
        priv_s3_li2:   "Procesar pagos y enviar notificaciones de facturación.",
        priv_s3_li3:   "Enviar comunicaciones relacionadas con el servicio (mantenimiento, actualizaciones, soporte).",
        priv_s3_li4:   "Detectar y prevenir fraudes, abusos o incidentes de seguridad.",
        priv_s3_li5:   "Cumplir con las obligaciones legales aplicables.",
        priv_s3_box:   "<strong>No vendemos</strong>, alquilamos ni compartimos tus datos personales con terceros con fines de marketing.",
        priv_s4_title: "4. Retención de Datos",
        priv_s4_desc:  "Conservamos tus datos personales mientras tu cuenta esté activa o según sea necesario para proporcionar los servicios. Puedes solicitar la eliminación de tus datos en cualquier momento contactándonos.",
        priv_s5_title: "5. Seguridad de Datos",
        priv_s5_desc:  "Implementamos medidas de seguridad estándar en la industria para proteger tus datos, incluido el cifrado SSL/TLS para todos los datos en tránsito y almacenamiento encriptado de contraseñas.",
        priv_s6_title: "6. Servicios de Terceros",
        priv_s6_desc:  "Utilizamos los siguientes servicios que pueden procesar tus datos bajo sus propias políticas de privacidad:",
        ...
        otherPlansDesc: "Desde servidores pequeños hasta redes masivas para comunidades grandes.",
